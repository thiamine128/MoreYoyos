...
public class YoyoDamageEnchantment extends Enchantment {
    ...
    public YoyoDamageEnchantment(Enchantment.Rarity p_44628_, int p_44629_, EquipmentSlot... p_44630_) {
        super(p_44628_, YoyosEnchantmentCategory.YOYO, p_44630_);
        this.type = p_44629_;
    }
    ...
    public boolean checkCompatibility(Enchantment p_44644_) {
        return !(p_44644_ instanceof YoyoDamageEnchantment);
    }
